...
model_path = '/path/to/caffe/models/bvlc_googlenet/' # substitute your path here
...
frame = deepdream(net, frame, end='inception_4c/5x5_reduce']) # see tmp.prototxt file for more layers
...
#    PIL.Image.fromarray(np.uint8(frame)).save("%04d.jpg"%frame_i)
